...
<template>
  <main style="margin-top: 2%">
    ...
    <div class="main__schedule-form" v-for="(couple, index) in couples" :key="couple.id">
      ...
      <div class="main__schedule-input-time">
        <p>Начало</p>
        <input v-model="couple.beginning" type="time" placeholder="8" />
        <p>Конец</p>
        <input v-model="couple.end" type="time" placeholder="13" />
      </div>

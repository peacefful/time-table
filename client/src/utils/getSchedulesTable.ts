...
export function getSchedulesTable(mondayCouple:object[], tuesdayCouple:object[], wednesdayCouple:object[], thursdayCouple:object[], fridayCouple:object[], saturdayCouple:object[]):object[] {
	return [

					...
					<div v-else>
						...
						<div v-if="schedulesData.monday">
							<div style="color: rgba(255, 255, 255, 0.763);" class="schedules-flex">
								<GetCoupleTable
									title="Понедельник"
									:couples="schedulesData.monday"
								/>
								<GetCoupleTable
									title="Вторник"
									:couples="schedulesData.tuesday"
								/>
								<GetCoupleTable
									title="Среда"
									:couples="schedulesData.wednesday"
								/>
								<GetCoupleTable
									title="Четверг"
									:couples="schedulesData.thursday"
								/>
								<GetCoupleTable
									title="Пятница"
									:couples="schedulesData.friday"
								/>
								<GetCoupleTable
									title="Суббота"
									:couples="schedulesData.saturday"
								/>
							</div>
						</div>

...
import { changeGroupStudents, changeGroupTutors, groups, students, tutors } from "@/API/api-enterprises-institutions";
		...
		<main v-if="animationBoolean" style="margin-top: 2%;" class="main">
			<form @submit.prevent="updateSchedules()">
				<div class="main__schedule">
					...
					<button style="margin-left: 2%;" class="schedules-add" @click.prevent="openStudentModal()">Добавить Студентов</button>
					<CoupleTable

...
import { getStudents, addStudent, deleteStudent, changeStudent, checkStudent, updateGroupId } from "../controllers/student-controller"
...
router.put("/api/students/:id", checkValidateDatas("name", 2, 20), checkValidateDatas("surname", 2, 20), checkValidateDatas("role", 7, 8), changeStudent)
